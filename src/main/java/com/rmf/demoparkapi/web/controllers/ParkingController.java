...
import com.rmf.demoparkapi.services.JasperService;
...
public class ParkingController {
    ...
    public ResponseEntity<Void> getReport(HttpServletResponse response, @AuthenticationPrincipal JwtUserDetails user) throws IOException {
        String identificationNumber = costumerService.getByUserId(user.getId()).getIdentificationNumber();
        jasperService.addParams("identificationNumber", identificationNumber);

        byte[] bytes = jasperService.buildPdf();
